...
pip install "../../dist/alphaviz-0.0.3-py3-none-any.whl[stable]"
...
pkgbuild --root dist/alphaviz --identifier de.mpg.biochem.alphaviz.app --version 0.0.3 --install-location /Applications/alphaviz.app --scripts scripts alphaviz.pkg
