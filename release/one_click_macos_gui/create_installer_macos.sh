...
pip install "../../dist/alphaviz-1.0.2-py3-none-any.whl[stable,gui-stable]"
...
pkgbuild --root dist/alphaviz --identifier de.mpg.biochem.alphaviz.app --version 1.0.2 --install-location /Applications/alphaviz.app --scripts scripts alphaviz.pkg
