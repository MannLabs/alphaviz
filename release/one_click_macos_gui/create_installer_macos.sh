...
pip install "../../dist/alphaviz-0.0.2-py3-none-any.whl[stable]"
...
pkgbuild --root dist/alphaviz --identifier de.mpg.biochem.alphaviz.app --version 0.0.2 --install-location /Applications/alphaviz.app --scripts scripts alphaviz.pkg
