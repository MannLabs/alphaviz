...
OutputDir=dist
OutputBaseFilename=alphaviz_gui_installer_windows
...
[Files]
Source: "dist\alphaviz_gui\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "dist\alphaviz_gui\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
