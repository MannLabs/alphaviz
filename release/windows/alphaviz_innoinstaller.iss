...
AppId={{alphaviz_Mann_Labs_MPI_CPR}
AppName={#MyAppName}
...
OutputDir=..\..\
; example for BUILD_NAME: alphaviz-1.3.0-windows-amd64
...
[Files]
Source: "..\..\dist_pyinstaller\alphaviz_gui\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\dist_pyinstaller\alphaviz_gui\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
