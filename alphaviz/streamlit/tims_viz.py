...
from alpharaw.viz.xic_plot_tims import XIC_Plot_Tims

from alpharaw.utils.centroiding import naive_centroid

from alphaviz.streamlit.raw_viz import model_mgr, load_psm, select_psm, psm_plotter
...
def show():
    ...
    if not tims_file or not psm_file or not psm_file_type:
        return
