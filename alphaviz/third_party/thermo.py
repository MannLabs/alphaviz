...
# @Feng: Wrapper of alphatims for Thermo Raw file
# This module is for test only, it is not fully tested.
# Thanks Sander Willems for adding this wrapper 

# pip install alphapept to enable rawfilereader
